...
class App extends Component {
 ...
 // a method When you click a CharComponent, it should be removed and removed from the enetered text.
 ...
 // String are kinda of JavaScript arrays but not really to turn them into arrays call split() on this will basically slips them in array of strings after every every character
      ...
      <div className="App">
            <h1 className="App-header"><u>Second React Practice Assignment Instructions:</u></h1>
              <ol className="Assignment-instructions">
                ...
                <li> Render a list of CharComponent where each CharComponent receives a different letter of the entered text (in the initial input fild) as a prop.</li>
        ...
        <p><i>Render a list of CharComponent where each CharComponent receives a different letter of the entered text (in the initial input fild) as a prop.</i></p>
         {charList}
